...
#define WALL_COLOR 4
float COLOR[WALL_COLOR +1][3] ={ {1,0,0}, {0,1,0}, {0,0,1}, {0,1,1}, {.734,.68,.195}};
/***       /Définitions       ***/
/***    Variables globales    ***/
GLuint id;/* id de la texture en damier */
/* variable pour faire bouger le plateau */
//float rotX=0,rotY=0,Z=16;
GLubyte image[16][16][3];/* pour stocker le damier */
short int edge[17][17];    /* sert a detecter les aretes */
//extern unsigned char board[16][16];
